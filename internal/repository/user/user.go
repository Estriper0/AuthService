...
func (r *UserRepository) Create(
	...
	query := "INSERT INTO auth.users (email, pass_hash, is_admin) VALUES ($1, $2, $3) RETURNING uuid"
...
func (r *UserRepository) GetByEmail(
	...
	query := "SELECT uuid, email, pass_hash, is_admin FROM auth.users WHERE email = $1"
...
func (r *UserRepository) IsAdmin(
	...
	query := "SELECT is_admin FROM auth.users WHERE uuid = $1"
